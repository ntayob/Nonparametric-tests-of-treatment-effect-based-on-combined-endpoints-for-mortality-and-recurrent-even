...
# Call:
#   coxph(formula = Surv(Time, Delta) ~ X_treat)
# 
# n= 200, number of events= 186 
# 
# coef exp(coef) se(coef)      z Pr(>|z|)  
# X_treat -0.3507    0.7042   0.1484 -2.362   0.0182 *
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# exp(coef) exp(-coef) lower .95 upper .95
# X_treat    0.7042       1.42    0.5264     0.942
# 
# Concordance= 0.543  (se = 0.021 )
# Rsquare= 0.027   (max possible= 1 )
# Likelihood ratio test= 5.57  on 1 df,   p=0.01825
# Wald test            = 5.58  on 1 df,   p=0.01816
...
GL_test_stat(0.5,time1,placebo_data_GL,active_data_GL)
